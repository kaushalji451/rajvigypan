    ...
    >
      <div className="flex items-center gap-4 pt-4">
        {iconMap[service.subtitle] || (
          <MdCampaign className="text-3xl text-[#ff7f30]" />
        )}
      ...
      <div className="lg:w-1/2 w-full flex flex-col px-6 lg:px-20 pt-10 lg:pt-20 max-sm:pb-10 bg-[#c4c4c440] rounded-4xl">
        <div className="w-full">
          ...
          <p className="pb-7">
            ...
            <strong> end-to-end creative and marketing solutions</strong>{" "}
            designed to elevate your brand, engage your audience, and deliver
          ...
          <ul className="list-disc pl-6 space-y-2 pb-7">
            <li>
              Advertising & Marketing — Integrated 360° campaigns across
              digital, print, and broadcast.
            </li>
            <li>
              Branding — Cohesive brand identities with storytelling, logos, and
              messaging.
            </li>
            <li>
              Event Planning — Memorable experiences through seamless execution
              and design.
            </li>
            <li>
              Outdoor Media — High-visibility placements with bold, impactful
              designs.
            </li>
          </ul>

          <h2 className="text-xl lg:text-2xl pt-6 pb-4 text-[#ff7f30]">
            Why Choose Us?
          </h2>
          <ul className="list-disc pl-6 space-y-2 pb-7">
          ...
          <p className="pb-7">
            We’ve had the privilege of working with leading brands and
          ...
          <p className="pb-7">
            Our <strong>data-driven approach</strong> and regional insights
            ensure that every campaign not only looks good but also drives real
            growth. Whether you are a startup or an enterprise, we turn{" "}
